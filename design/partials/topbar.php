<div id="announcement-bar" class="site-topbar flex min-h-[30px] w-full items-center overflow-hidden bg-[#010062] py-1" role="region" aria-label="Announcements">
    <div class="site-container grid grid-cols-[1fr_auto] items-center gap-2 sm:grid-cols-[1fr_auto_1fr]">
        ...
        <p class="site-topbar__copy m-0 flex min-w-0 items-center justify-start gap-2 sm:justify-center">
            <img src="/images/rocket_icon.svg" alt="" class="h-3.5 w-3.5 shrink-0 object-contain" aria-hidden="true">
            <a href="/product" class="site-topbar__text min-w-0 no-underline hover:opacity-90">
                <span class="bg-gradient-to-r from-[#2A4DFB] to-[#7A5FF8] bg-clip-text text-[11px] font-bold leading-[1.35] text-transparent sm:text-xs">Introducing SUAVE CRM</span>
                <span class="hidden text-[11px] font-semibold leading-[1.35] text-white min-[480px]:inline sm:text-xs"> — The Smarter Way to Manage Your Business.</span>
            </a>
