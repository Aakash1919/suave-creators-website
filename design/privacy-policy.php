<?php
$pageTitle = 'Privacy Policy | Suave Creators';
$pageDescription = 'Learn how Suave Creators collects, uses, and protects your personal information when you visit our website or contact our team.';
...
<section class="full-bleed bg-[url('/images/web-bg.png')] bg-cover bg-top bg-no-repeat py-12 sm:py-16 lg:py-20" aria-labelledby="privacy-policy-heading">
