...
| `blog/blogs-hero/` | Blog hero photos | `assets/blog/blogs-hero/01-team_.webp` |
...
| `media/` | Fallback — banners, photos, illustrations, process SVGs | `assets/media/seo-infographic-on-imac_.webp` |
...
| `market-1.png` | `seo-infographic-on-imac_.webp` |
