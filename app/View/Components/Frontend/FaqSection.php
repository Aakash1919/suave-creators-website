...
class FaqSection extends Component
{
    ...
    public function __construct(
        ...
        public string $title = 'Frequently Asked Questions: Delivery, Pricing & Code Ownership',
        public string $description = 'Direct answers to the most common questions we receive from founders, CTOs, and enterprise leaders.',
