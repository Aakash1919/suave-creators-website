...
class ImageVariantService
{
    ...
    public function storeWithVariants(UploadedFile $file, string $directory, string $basename): array
    {
        ...
        $thumbs = $this->generateThumbnails($file, $originalPath);
     ...
     */
    public function generateThumbnails(UploadedFile $file, string $originalPath): array
    {
        ...
        $image = $manager->read($file->getRealPath() ?: $file->path());
        $thumbnailPaths = [];
