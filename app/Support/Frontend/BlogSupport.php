...
class BlogSupport
{
    ...
    public static function heroImages(): array
    {
        return [
            ...
            ['src' => asset('assets/blog/blogs-hero/02-laptop_.webp'), 'alt' => 'Laptop with code for web development insights blog', 'size' => 'md'],
            ['src' => asset('assets/blog/blogs-hero/03-creative_.webp'), 'alt' => 'Creative team collaboration for digital strategy blog articles', 'size' => 'lg'],
