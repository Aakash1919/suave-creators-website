...
<section class="full-bleed web-services{{ $capabilitiesAsSlider ? ' web-services--capabilities-slider' : '' }}{{ in_array($service['slug'] ?? '', ['web-development-services', 'custom-crm-development', 'enterprise-software-solutions','e-commerce-development'], true) ? ' web-services--brown-hover' : '' }} bg-cover bg-top bg-no-repeat section-pad-m py-6 lg:py-20" style="background-image: url('{{ asset('assets/background/web-services-section-bg.png') }}')" aria-labelledby="service-capabilities-heading">
