...
@section('content')
@php
  $ctaArrow = '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="transition-transform duration-300 group-hover:translate-x-1" aria-hidden="true"><path d="M18 8L22 12L18 16"/><path d="M2 12H22"/></svg>';
  ...
  <div class="section-inner rounded-2xl bg-cover bg-center bg-no-repeat p-5 sm:p-8 lg:p-12"
    ...
    <div class="grid items-center gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12">
      ...
      <div class="order-1 max-w-[640px] text-left lg:order-2">
        ...
        <a href="{{ route('contact-us') }}#contact-id" class="{{ $btnPrimary }} mt-6 sm:mt-8">
