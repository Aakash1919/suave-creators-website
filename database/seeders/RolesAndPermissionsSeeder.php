...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            'case-studies.view' => 'View case studies',
            'case-studies.create' => 'Create case studies',
            'case-studies.update' => 'Update case studies',
            'case-studies.delete' => 'Delete case studies',
